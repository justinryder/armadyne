Shader "Custom/SimpleReliefMapping" {
Properties {
...
//INFO http://http.developer.nvidia.com/GPUGems3/gpugems3_ch18.html
//http://forums.nvidia.com/index.php?showtopic=34767
SubShader {
		...
		void surf (Input IN, inout SurfaceOutput o) {
			...
			const int binarySearchSteps = 12;
